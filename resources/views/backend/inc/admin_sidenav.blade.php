    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-logo">
            @if(get_setting('system_logo_white') != null)
                 <img src="{{ uploaded_asset(get_setting('system_logo_white')) }}" style="width:25%;" style="width:100%;max-height: 25px;" alt="@if(get_setting('site_name')) {{ get_setting('site_name') }} @else {{ translate('Asya Fawry') }} @endif">
            @else

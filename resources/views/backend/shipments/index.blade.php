                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-xl-12 mb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="my-2 col-md-4 my-md-0">
                                <div class="input-icon">
                                    <input type="text" name="order_id" value="<?php if (isset($_GET['order_id'])) {
                                                                                echo $_GET['order_id'];
                                                                            } ?>" class="form-control" placeholder="{{translate('Shipment Order ID')}}" id="" />
                                    <span>
                                        <i class="flaticon2-search-1 text-muted"></i>
                                    </span>
                                </div>
                            ...
                            <div class="my-2 col-md-4 my-md-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select name="sort_by" class="form-control kt-select2 select-sort" >
                                        ...
                                        <option @if(isset($_GET['sort_by']) && $_GET['sort_by']==\App\Shipment::LATEST) selected @endif value="{{\App\Shipment::PICKUP}}">{{translate('Latest')}}</option>
                                        @endif
                                        @if($sort_by == null || $sort_by == \App\Shipment::OLDEST)
                                        <option @if(isset($_GET['sort_by']) && $_GET['sort_by']==\App\Shipment::OLDEST) selected @endif value="{{\App\Shipment::DROPOFF}}">{{translate('Oldest')}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>

        ...
        <form class="form-horizontal" action="{{ route('admin.shipments.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="mb-0 text-right form-group w-full" style="padding-left: 50%;" >
                        <button type="button" class="btn btn-sm btn-primary w-12"    onclick="get_estimation_cost()">{{translate('Save')}}</button>

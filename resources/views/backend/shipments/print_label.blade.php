                        ...
                        <tr>
                            <td height="21px" colspan="3" style="padding: auto;">
                                <table style="padding: auto;" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="middle" style="padding-left:5px; height: 20px;">

                                            @if(get_setting('system_logo_white') != null)
                                                <img src="{{ uploaded_asset(get_setting('system_logo_white')) }}">
                                            @else
                                                <img src="{{ static_asset('assets/img/logo.svg') }} " style="width: 50px">
                                            @endif
                                        </td>
                                    </tr>
                                </table>
                                                            ...
                                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <br />
                                                                        {{translate('Order ID')}}: {{$shipment->order_id}} / {{$shipment->code}} / {{$shipment->total_weight}} {{translate('Kg')}} / {{\Carbon\Carbon::parse($shipment->shipping_date)->format('d-m-Y')}}
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                ...
                <div class="upper-units-container">
                    <div class="upper-units-container">
                        ...
                        <div class="float-right item-info-container text-align-right">
                            {{translate('Shipment date')}}:<span> {{\Carbon\Carbon::parse($shipment->shipping_date)->format('d-m-Y')}}</span>
                        </div>
                    </div>
                    <div class="upper-units-container">

                ...
                {{-- <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control kt-select2 branch" id="branch_id" name="branch_id">
                            ...
                            <option  @if($staff->branch_id == $branch->id) selected @endif value="{{$branch->id}}">{{$branch->name}}</option>
                            @endforeach
...
<script type="text/javascript">
    ...
    $('.branch').select2({
          ...
          language: {
            noResults: function() {
              return `<li style='list-style: none; padding: 10px;'><a style="width: 100%" href="{{route('admin.branchs.create')}}?redirect=admin.staffs"

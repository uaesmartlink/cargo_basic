...
<div class="mx-auto col-lg-12">
    <div class="card">
        ...
        <form class="form-horizontal" onsubmit="validate()" action="{{ route('admin.clients.update',['client'=>$client->id]) }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PATCH') }}
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @endphp
                            <input type="text" class="form-control" id="owner_name" value="{{$name}}" placeholder="{{translate('Here')}}" name="Client[responsible_name]">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*
        form.querySelector('[name="Client[responsible_mobile]"]').addEventListener('change', function () {

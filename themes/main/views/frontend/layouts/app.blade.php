...
<head>
    ...
    @php
        $base_color = setting()->get('main_base_color_'.app()->getLocale() );
        $alternative_color = setting()->get('main_alternative_color_'.app()->getLocale() );
    @endphp
    @if( $base_color && $alternative_color )
        <style>
            :root {
